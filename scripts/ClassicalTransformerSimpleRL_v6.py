"""
Classical Transformer Baseline for Simple RL Environments -- v6
================================================================
Fair classical baseline matched to QuantumTransformerSimpleRL_v6.

v1 base architecture choices:
  - MSELoss (not SmoothL1Loss)
  - No gradient clipping
  - Epsilon decay per step (inside learn())
...
Note: Classical transformer keeps sinusoidal PE since it's standard practice
for classical transformers and was used in all prior classical baselines.
"""
...
def get_args():
    parser = argparse.ArgumentParser(
        description='Classical Transformer v6 for Simple RL Environments'
    )
...
RUN_ID = f"ClassicalV6_{env_name_clean}_Run{args.log_index}"
if args.save_dir:
...
class ClassicalTSTransformerRL(nn.Module):
    """Classical transformer baseline with sinusoidal PE."""
    def __init__(self, state_dim: int, d_model: int, n_heads: int,
        ...
        # Sinusoidal PE (standard for classical transformers)
...
# ================================================================================
# DQN AGENT (v6: anti-forgetting)
# ================================================================================
class ClassicalSimpleRLAgent_v6:
    ...
    def load_checkpoint(self, checkpoint_path):
        ...
        print(f"Resumed from Episode {completed_episode + 1}")
...
def train():
    ...
    agent = ClassicalSimpleRLAgent_v6(
        state_processor,
    ...
    print("\n" + "=" * 80)
    print(f"CLASSICAL TRANSFORMER V6 BASELINE - {args.env}")
    print("=" * 80)
    print(f"\nConfiguration:")
